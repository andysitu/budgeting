...
const addToHolding = async (addToHoldingData: AddToHolding) => {
  if (
    (addToHoldingData.amount == null ||
      addToHoldingData.amount == "" ||
      !(addToHoldingData.amount > 0)) &&
    (addToHoldingData.shares == null ||
      addToHoldingData.shares == "" ||
      !(addToHoldingData.shares > 0))
  ) {
